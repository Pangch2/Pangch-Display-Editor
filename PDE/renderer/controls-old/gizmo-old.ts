...
} from './blockbench-scale-old';
import * as GroupUtils from './group-old';
import * as Overlay from './overlay-old';
import * as CustomPivot from './custom-pivot-old';
...
import { processVertexScale } from './vertex-scale-old';
import * as Select from './select-old';
import type { SelectionState } from './select-old';
import type { GroupData } from './group-old';
import type { QueueItem } from './vertex-swap-old';
import * as VertexQueue from './vertex-queue-old';
