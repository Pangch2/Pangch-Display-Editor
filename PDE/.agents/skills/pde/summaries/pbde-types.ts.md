...
- `GeometryInstanceMeta` -- per-instance transform/uuid/group/name data for a batched geometry shape, including optional atlas UV transform, block properties, and item-display metadata
