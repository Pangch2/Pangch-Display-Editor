...
## Purpose
Defines the renderer shell: loading overlay, canvas, independent left/right panel docks containing Scene Objects and editable Project Details sections, project navigation controls, FPS counter, and renderer module entrypoint.
