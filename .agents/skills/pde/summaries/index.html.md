...
## Purpose
Defines the renderer shell: loading overlay, canvas, independent left/right panel docks containing Scene Objects and a shared Project Details/Object Properties section, project navigation controls, FPS counter, and renderer module entrypoint.
...
- Project name, project NBT, and full NBT use single-line text inputs; project details also expose a global-brightness checkbox with sky/block selects.
