...
- `pickInstanceByOverlayBox(raycaster, rootGroup)` -- raycasts rendered instanced geometry, compares every instance's world-space bounds as a fallback, and returns the closest valid hit.
