...
- `GeometryInstanceMeta` -- per-instance transform/uuid/group/name data for a batched geometry shape, including optional single or per-part atlas UV transforms, block properties, and item-display metadata
