...
- Collection `pivotCustom` values are transformed from collection-local to world coordinates and tagged explicitly as custom; missing pivots use the default sentinel.
